...
For listed equity holdings, financed emissions are estimated using a proxy approach where direct issuer emissions are not captured in investment records.

**Methodology (listed equity):** **market_value_meur / issuer_evic_meur × issuer_revenue_meur (PCAF Standard §B61 proxy — revenue is used as the proxy basis)**.

For certain holdings, the proxy basis is **issuer_revenue_meur** and the proxy rationale is: **Revenue used as PCAF B61 proxy. Do not treat as verified emissions.**
...
- **Investment decisions (financed emissions and lending decisions): EUR 42.73/tCO₂e**
- **Product pricing: EUR 48.73/tCO₂e**
- **Lending decisions (incremental price): EUR 54.73/tCO₂e**
