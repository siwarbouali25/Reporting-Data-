# IFRS S1/S2 Automated Requirements KB Audit Summary — Final Polished Version With Check Cells
...
- Requirement rows: 576
- Leaf requirement rows: 534
...
| IFRS S2    | Metrics and Targets  |            175 |
...
| IFRS S2    | Metrics and Targets  |                 154 |
...
|:-------------------------|-------:|
| container_context        |     42 |
| must_disclose_leaf       |    361 |
| optional_relief_leaf     |     56 |
| supporting_guidance_leaf |    106 |
...
| Leaf requirement rows are identified                     | True     | leaf_rows=534                                                                                                                   |
