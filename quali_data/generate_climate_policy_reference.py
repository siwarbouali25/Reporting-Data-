...
# ---------------------------------------------------------------------------
INTL_AGREEMENTS = {
    "Paris Agreement 1.5C": {"temp_c": 1.5, "year": 2015, "body": "UNFCCC"},
    "Paris Agreement 2C":   {"temp_c": 2.0, "year": 2015, "body": "UNFCCC"},
    ...
    for _, ent in entities.iterrows():
        ...
        for yr in years:
            ...
            if scenario_temps:
                ...
                if min_temp <= 1.5:
                    agr_key = "Paris Agreement 1.5C"
                elif min_temp <= 2.0:
                    agr_key = "Paris Agreement 2C"
                else:
